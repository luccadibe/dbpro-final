...
/**
 * Creates tables in the provided SQLite database.
 * 
...
/**
 * Loads data from .tbl files into the corresponding tables in the SQLite database.
 * 
 * @param db A pointer to the SQLite database.
 * @return 1 on success, 0 on failure.
 */
...
/**
 * Loads tables multiple times into the database and measures the time taken.
 * Creates and deletes the database after each iteration.
 * 
 * @return 1 on success, 0 on failure.
 */
int preLoadTables() {
...
/**
 * Refreshes the database with new sales information (RF1).
 * Inserts new records into the `ORDERS` and `LINEITEM` tables.
 * 
 * @param db A pointer to the SQLite database.
 * @param orders_filename The filename of the orders data file.
 * @param lineitem_filename The filename of the lineitem data file.
 * @return 1 on success, 0 on failure.
 */
...
/**
 * Refreshes the database by deleting records from the `ORDERS` table (RF2).
 * Deletes records based on order keys provided in the delete file.
 * 
 * @param db A pointer to the SQLite database.
 * @param delete_filename The filename of the delete data file.
 * @return 1 on success, 0 on failure.
 */
 ...
 * Used for measuring and logging execution times.
 */
 ...
 * Opens the SQLite database, creates and loads tables, executes queries, and logs execution times.
 * 
...
int main(int argc, char* argv[]) {
   ...
   // preLoadTables();
    ...
    char orders_filename[256];
    char lineitem_filename[256];
